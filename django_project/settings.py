...
SECRET_KEY = 'django-insecure-9s=lp0lnsulvklcxlw-zh@nkj^4v_2^16wtv4dwppc8ci7ug*n'
...
# Если вы хотите разрешить доступ из всех источников (не рекомендуется для продакшена)
